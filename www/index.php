...
$_OPTIMIZATION["keywords"] = "Заработок на животных, вложения, заработать, ферма, денежная ферма, заработать на ферме";
...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
				...
				case "help": include("pages/_help.php"); break; // Выплаты
