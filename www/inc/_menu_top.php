...
<li><a href="/rules.html" <?=(isset($_GET["menu"]) AND strtolower($_GET["menu"]) == "rules") ? 'class="current"' : False; ?>>Соглашение</a></li>		
	...
	<li><a class="greenline-under" href="/account.html">Привет, <?=$_SESSION["user"]?>!</a></li>
	<li><a class="greenline-under" href="/account/exit.html">Выход</a></li>
	<?php } else { ?>
	<li><a class="greenline-under" href="/signup.html">Вход/Регистрация</a></li>
	<?php } ?>
</ul> 
	</nav></div></div></header>