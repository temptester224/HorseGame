...
$all_items = $user_data["a_b"] + $user_data["b_b"] + $user_data["c_b"] + $user_data["d_b"] + $user_data["e_b"] + $user_data["r_b"] + $user_data["t_b"] + $user_data["y_b"] + $user_data["u_b"];
	...
	if($all_items > 0){
		...
		echo "<script>setTimeout(function(){swal(\"Вы обналичили кассу\", \"Успешно\")}, 500); </script>";
		
		$db->Query("SELECT * FROM db_users_b WHERE id = '$usid' LIMIT 1");
		$user_data = $db->FetchArray();
		
	}else echo "<script>setTimeout(function(){swal(\"Вам нечего собрать!\", \"Ошибка\")}, 500);</script>";
...
<?php 
	...
	if(isset($_POST["sbor"])){
		...
		if($user_data["last_sbor"] < (time() - 600) ){
			...
			echo "<script>setTimeout(function(){swal(\"Вы собрали кассу\", \"Успешно\")}, 500); </script>";
			
			$db->Query("SELECT * FROM db_users_b WHERE id = '$usid' LIMIT 1");
			$user_data = $db->FetchArray();
			
		}else echo "<script>setTimeout(function(){swal(\"Кассу  можно собирать не чаще 1го раза за 10 минут\", \"Ошибка\")}, 500);</script>";
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center">
                                <h1 style="margin-top: 0;">
                                    <span id="bls"><?=$func->SellItems($user_data["a_b"] + $user_data["b_b"] + $user_data["c_b"] + $user_data["d_b"] + $user_data["e_b"] + $user_data["r_b"] + $user_data["t_b"] + $user_data["y_b"] + $user_data["u_b"], $sonfig_site["items_per_coin"]); ?></span> <small>руб.</small>
                                </h1>
                                <h2>
...
<center><input type="submit" name="sbor" value="Собрать кассу" class="btn btn-block btn-danger waves-effect"/></center>
</form>
                        </div>
                    </div>
	...
	display: inline-block;
							...
							<form action="" method="post">
	<input type="submit" name="sell" value="Обналичить кассу" class="btn btn-block btn-primary waves-effect" style="height: 30px;"></form>
                        </div>
                    </div>
	...
	display: inline-block;
                    ...
                    <img src="/assets/img/car/car-1.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["a_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-2.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["b_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-3.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["c_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-4.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["d_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-5.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["e_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-6.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["r_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-7.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["t_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-8.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["y_t"]; ?>	</span>	
                  </div>
				  <div class="col-lg-1 col-sm-1 col-xs-1">
                    <img src="/assets/img/car/car-9.png" style="width: 100%;" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=";font-family:Monotype Corsiva;
font-size:22px;color:blue;"><?=$user_data["u_t"]; ?>		</span>
                  </div>
